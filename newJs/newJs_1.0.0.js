...
function newJs(){
	...
	newJs.bind = function(opt){
		...
		new_Js_t.data = '';
		new_Js_t.dataObj = '';
		new_Js_t.method ="new_Js_t.new_Js_method = " + opt.method.toString() + '; new_Js_t.new_Js_method();';
		for(var key in opt.data){
			new_Js_t.data = new_Js_t.data + 'var ' +  key + '=' + JSON.stringify(opt.data[key]) + ';' 
					+'new_Js_t.newJs_bind_opt_data =' + JSON.stringify(opt.data).toString() + ';';
		};
		new_Js_t.retrnData = 
		'new_Js_t.retrnDataC = function(){' +
		...
		for (var i = 0; i < new_Js_t.newJsLabel.length; i++) {
			var bingHtml = {};
			bingHtml.data = '';
			bingHtml.getRetrn = new_Js_t.getRetrn;
			for(var key in bingHtml.getRetrn){
				bingHtml.data = bingHtml.data + 'var ' +  key + '=' + JSON.stringify(bingHtml.getRetrn[key]) + ';';
			};
			bingHtml.getRetrn = 'return ' + new_Js_t.newJsLabel[i].innerHTML ;
